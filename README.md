...
For more information about AIDA, see AIDA User's Guide in the [IBM Workload Automation documentation](https://www.ibm.com/docs/en/workload-automation/10.2.4?topic=ai-data-advisor-aida-users-guide).


## Prerequisites

 -  IBM Workload Automation V10.1 or higher exposed metrics.
    - For information about IBM Workload Automation exposed metrics, see "Exposing metrics to monitor your workload" in the [IBM Workload Automation documentation](https://www.ibm.com/docs/en/workload-automation/10.2.4?topic=scheduler-exposing-metrics-monitor-your-workload).  
    - For information about IBM Z Workload Automation exposed metrics, see "Exposing metrics to monitor your workload" in the [IBM Z Workload Scheduler documentation](https://www.ibm.com/docs/en/workload-automation/10.2.4) Managing the Workload manual.    
...
The images are as follows:
 ...
 - ``cp.icr.io/cp/aida-ad:10.2.4`` 
 - ``cp.icr.io/cp/aida-exporter:10.2.4``
 - ``cp.icr.io/cp/aida-email:10.2.4``
 - ``cp.icr.io/cp/aida-nginx:10.2.4``
 - ``cp.icr.io/cp/aida-orchestrator:10.2.4``
 - ``cp.icr.io/cp/aida-predictor:10.2.4``
 - ``cp.icr.io/cp/aida-redis:10.2.4``
 - ``cp.icr.io/cp/aida-config:10.2.4``
 - ``cp.icr.io/cp/aida-ui:10.2.4``
...
If you are using AIDA V10.1 or V10.2.0.0 with Keycloak V17.0.0 and want to update your AIDA installation to V10.2.4,  you must first migrate your previous Keycloak V17.0.0 data to Keycloak V22.0.0.
