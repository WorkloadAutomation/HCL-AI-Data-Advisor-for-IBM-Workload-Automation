...
<<<<<<< HEAD
 - ``cp.icr.io/cp/ibm-workload-automation-aida-ad:10.2.4`` 
 - ``cp.icr.io/cp/ibm-workload-automation-aida-exporter:10.2.4``
 - ``cp.icr.io/cp/ibm-workload-automation-aida-email:10.2.4``
 - ``cp.icr.io/cp/ibm-workload-automation-aida-nginx:10.2.4``
 - ``cp.icr.io/cp/ibm-workload-automation-aida-orchestrator:10.2.4``
 - ``cp.icr.io/cp/ibm-workload-automation-aida-predictor:10.2.4``
 - ``cp.icr.io/cp/ibm-workload-automation-aida-redis:10.2.4``
 - ``cp.icr.io/cp/ibm-workload-automation-aida-ui:10.2.4``
=======
